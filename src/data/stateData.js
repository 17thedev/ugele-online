const stateData = {
  'Abia': [
    'Aba North','Aba South','Arochukwu','Bende','Isuikwuato','Obi Ngwa',
    'Ohafia','Osisioma','Ugwunagbo','Ukwa East','Ukwa West',
    'Umuahia North','Umuahia South','Umu Nneochi'
  ],
  'Adamawa': [
    'Demsa','Fufure','Ganye','Gayuk','Gombi','Guyuk','Hong','Jada',
  ...
  'Osun': [
    'Atakumosa East','Atakumosa West','Aiyedaade','Aiyedire','Boluwaduro',
