    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", minHeight: '100vh', background: '#060d1a', color: 'white' }}>
      ...
      <div className="top-nav">
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button onClick={() => navigate('/login')} style={{ background: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.6)', border: '1px solid rgba(255,255,255,0.08)', padding: '8px 18px', borderRadius: 10, fontFamily: 'DM Sans, sans-serif', fontWeight: 600, fontSize: 13, cursor: 'pointer', transition: 'all 0.3s' }}
            onMouseOver={e => e.currentTarget.style.background = 'rgba(255,255,255,0.1)'}
            onMouseOut={e => e.currentTarget.style.background = 'rgba(255,255,255,0.05)'}
          >Login</button>
          <button onClick={() => navigate('/register')} style={{ background: 'linear-gradient(135deg, #FF6B4A, #e55a3a)', color: 'white', border: 'none', padding: '8px 18px', borderRadius: 10, fontFamily: 'DM Sans, sans-serif', fontWeight: 700, fontSize: 13, cursor: 'pointer', boxShadow: '0 0 14px rgba(255,107,74,0.25)' }}>
            Register
          </button>
        </div>
      </div>
      ...
      <div style={{ background: 'linear-gradient(135deg, #0A2540 0%, #060d1a 100%)', padding: '48px 24px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <input className="search-field" type="text" placeholder="Search by name or service..." value={search} onChange={e => setSearch(e.target.value)} />
